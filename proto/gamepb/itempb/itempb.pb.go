...
type SellReply struct {
	...
	GetItems      []*corepb.Item         `protobuf:"bytes,2,rep,name=get_items,json=getItems,proto3" json:"get_items,omitempty"`    // 获得的物品（id=1001为金币, id=1002为点券）
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *UseItem) GetItemId() int64 {
	if x != nil {
		return x.ItemId
	}
	return 0
...
type BatchUseRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Items         []*UseItem             `protobuf:"bytes,1,rep,name=items,proto3" json:"items,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *BatchUseRequest) GetItems() []*UseItem {
	if x != nil {
		return x.Items
	}
	return nil
...
const file_itempb_proto_rawDesc = "" +
	...
	"\bUseReply\x12\"\n" +
	"\x05items\x18\x01 \x03(\v2\f.corepb.ItemR\x05items\"8\n" +
	"\aUseItem\x12\x17\n" +
	"\aitem_id\x18\x01 \x01(\x03R\x06itemId\x12\x14\n" +
	"\x05count\x18\x02 \x01(\x03R\x05count\"?\n" +
	"\x0fBatchUseRequest\x12,\n" +
	"\x05items\x18\x01 \x03(\v2\x16.gamepb.itempb.UseItemR\x05items\"3\n" +
	"\rBatchUseReply\x12\"\n" +
	"\x05items\x18\x01 \x03(\v2\f.corepb.ItemR\x05itemsB#Z!gofarm/proto/gamepb/itempb;itempbb\x06proto3"
...
var file_itempb_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
var file_itempb_proto_goTypes = []any{
	...
	(*UseItem)(nil),         // 6: gamepb.itempb.UseItem
	(*BatchUseRequest)(nil), // 7: gamepb.itempb.BatchUseRequest
	(*BatchUseReply)(nil),   // 8: gamepb.itempb.BatchUseReply
	(*corepb.ItemBag)(nil),  // 9: corepb.ItemBag
	(*corepb.Item)(nil),     // 10: corepb.Item
}
var file_itempb_proto_depIdxs = []int32{
	9,  // 0: gamepb.itempb.BagReply.item_bag:type_name -> corepb.ItemBag
	10, // 1: gamepb.itempb.SellRequest.items:type_name -> corepb.Item
	10, // 2: gamepb.itempb.SellReply.sell_items:type_name -> corepb.Item
	10, // 3: gamepb.itempb.SellReply.get_items:type_name -> corepb.Item
	10, // 4: gamepb.itempb.UseReply.items:type_name -> corepb.Item
	6,  // 5: gamepb.itempb.BatchUseRequest.items:type_name -> gamepb.itempb.UseItem
	10, // 6: gamepb.itempb.BatchUseReply.items:type_name -> corepb.Item
